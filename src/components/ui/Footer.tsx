import {EmailIcon, InstagramIcon, PhoneIcon, SupportIcon, TelegramIcon} from "./icons.tsx";
        ...
        <div className={'bg-white'}>
            <div className={'container mx-auto mt-3 '}>
                <div className="flex flex-col font-medium md:flex-row justify-between items-center p-4 w-full">
                    ...
                    <div
                        className="w-full md:w-1/2 mb:mb-0 mb-10 mt-6 md:mt-0 flex flex-col items-center md:items-start">
                        <div
                    ...
                    <div className="w-full md:w-1/2">
                        <div
                            className="grid grid-cols-2 md:flex flex-wrap md:flex-col md:space-y-7 md:gap-0 gap-2 items-">
                            {/* Phone */}
                            <div
                                className="flex flex-grow flex-row-reverse items-center bg-orange-100/70 rounded-lg overflow-hidden">
